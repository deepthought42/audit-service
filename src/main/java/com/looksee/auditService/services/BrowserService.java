...
import com.looksee.auditService.models.BrowserConnectionHelper;
import com.looksee.auditService.models.ElementState;
import com.looksee.auditService.models.ImageElementState;
import com.looksee.auditService.models.ImageFaceAnnotation;
import com.looksee.auditService.models.ImageLandmarkInfo;
import com.looksee.auditService.models.ImageSearchAnnotation;
...
public class BrowserService {
	...
	public Map<String, Template> findTemplates(List<com.looksee.auditService.models.Element> element_list){
		//create a map for the various duplicate elements
		Map<String, Template> element_templates = new HashMap<>();
		List<com.looksee.auditService.models.Element> parents_only_element_list = new ArrayList<>();
		for(com.looksee.auditService.models.Element element : element_list) {
			if(!element.isLeaf()) {
		...
		for(int idx1 = 0; idx1 < parents_only_element_list.size()-1; idx1++){
			com.looksee.auditService.models.Element element1 = parents_only_element_list.get(idx1);
			...
			for(int idx2 = idx1+1; idx2 < parents_only_element_list.size(); idx2++){
				com.looksee.auditService.models.Element element2 = parents_only_element_list.get(idx2);
